...
@set INCLUDES= /I .\ /I "C:\OpenSSL\Win32\include" /I "C:\OpenSSL\Win64\include"
...
@set LIBS=/LIBPATH:"C:\OpenSSL\Win32\lib" /LIBPATH:"C:\OpenSSL\Win64\lib" libcrypto.lib libcrypto_static.lib libssl.lib libssl_static.lib
mkdir %OUT_DIR%
